...
class ListService_valuation_type extends ListController {
    ...
    public function getPageData(): array {
        ...
        $pageData['title'] = 'Conceptos - valoraciones';
    ...
    protected function createViews() {
        $this->createViewService_valuation_type();
    }
    
    protected function createViewService_valuation_type($viewName = 'ListService_valuation_type')
    {
        $this->addView($viewName, 'Service_valuation_type');
