...
// Lo que modifiquemos en este controlador, tendríamos que ver si lo modificamos en el controlador EditEmployee_documentation.php

namespace FacturaScripts\Plugins\OpenServBus\Controller;

use FacturaScripts\Core\Lib\ExtendedController\EditController;

class EditEmployee_documentation_2 extends EditController {

    use \FacturaScripts\Core\Lib\ExtendedController\DocFilesTrait;

    public function getModelClassName() {
        return 'Employee_documentation_2';
    }
    ...
    protected function loadData($viewName, $view) {
        switch ($viewName) {
            ...
            case 'EditEmployee_documentation': 
