...
class ListIdentification_mean extends ListController {
    ...
    public function getPageData(): array {
        ...
        $pageData['title'] = 'Identificación - medios';
    ...
    protected function createViews() {
        $this->createViewIdentification_mean();
    }
    
    protected function createViewIdentification_mean($viewName = 'ListFuel_pump')
    {
        $this->addView($viewName, 'Identification_mean');
