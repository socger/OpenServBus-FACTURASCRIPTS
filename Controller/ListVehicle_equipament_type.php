...
class ListVehicle_equipament_type extends ListController {
    ...
    protected function createViews() {
        $this->createViewVehicle_equipament_type();
    }
    
    protected function createViewVehicle_equipament_type($viewName = 'ListVehicle_equipament_type')
    {
        $this->addView($viewName, 'Vehicle_equipament_type');
