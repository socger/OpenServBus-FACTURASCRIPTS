...
class ListCard_type extends ListController {
    ...
    protected function createViews() {
        $this->createViewCard_type();
    }
    
    protected function createViewCard_type($viewName = 'ListCard_type')
    {
        $this->addView($viewName, 'Card_type');
