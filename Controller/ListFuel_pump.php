...
class ListFuel_pump extends ListController {
    ...
    public function getPageData(): array {
        ...
        $pageData['title'] = 'Surtidores interno';
    ...
    protected function createViewFuel_pump($viewName = 'ListFuel_pump')
    {
        $this->addView($viewName, 'Fuel_pump');
