...
class ListAbsence_reason extends ListController {
    ...
    public function getPageData(): array {
        ...
        $pageData['title'] = 'Ausencias - motivos';
    ...
    protected function createViews() {
        $this->createViewAbsence_reason();
    }
    
    protected function createViewAbsence_reason($viewName = 'ListFuel_pump')
    {
        $this->addView($viewName, 'Absence_reason');
