...
class ListEmployee_contract extends ListController {
    ...
    protected function createViews() {
        $this->createViewEmployee_contract();
    }
    
    protected function createViewEmployee_contract($viewName = 'ListEmployee_contract')
    {
        $this->addView($viewName, 'Employee_contract');
