...
class ListService_regular_combination extends ListController {
    ...
    protected function createViews() {
        $this->createViewService_regular_combination();
    }
    
    protected function createViewService_regular_combination($viewName = 'ListService_regular_combination')
    {
        $this->addView($viewName, 'Service_regular_combination');
